...
var questions = [
    new Question("The roman emperor Tiberius forbid men from wearing what?", ["High Heeled Shoes", "Silk","The Colour Green", "Long Dresses"], "The Colour Green"),
    new Question("In 14th century England, who was allowed to wear fur?", ["Knights or Above", "Royals", "Slaves", "All"], "Knights or Above"),    
    new Question("What did Russia's Tsar Peter 1 decree?", ["Must shave their beards", "Should wear western cloths", "Both", "None of above"], "Both"),
    new Question("John of arc was tried for what sartorial offence?", ["Flaunting her clavicle", "Showing bare head","Dressing like a man", "Wearing boots"], "Dressing like a man"),
    new Question("Who was the first designer and couturier to create collections?", ["Paul Poiret", "Coco Chanel", "Charles Fedrick Worth", "Barbara Hulanicki"], "Charles Fedrick Worth"),
    new Question("By the 19th century, women’s fashion was largely a product of what nation?", ["France", "US", "England", "Greece"], "France"),
    new Question("When did the zipper become a clothing mainstay?", ["1930s", "1830s","1730s", "1630s"], "1930s"),
    new Question("Where did denim originate?", ["New York", "Nimes", "Milano", "Athens"], "Nimes"),
    new Question("Where do shoes with curled toes come from?", ["Elves", "Scandinavians","Aristocrats", "Egyptians"], "Scandinavians"),
    new Question("When did the first fashion magazine appear?", ["1886", "1786", "1686", "1586"], "1586")
];
